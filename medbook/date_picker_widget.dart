...
class DatePicker extends StatefulWidget {
  ...
  final List<int>? inactiveWeekDay;
  final List<DateTime>? exceptDay;
...
//            print("Inside Inactive dates.");
          ...
          if (widget.inactiveWeekDay != null) {
            if (widget.inactiveWeekDay!.contains(date.weekday)) {
              isDeactivated = true;
            }
          }

          if (widget.exceptDay != null) {
            if (widget.exceptDay!.contains(date)) isDeactivated = false;
          }
